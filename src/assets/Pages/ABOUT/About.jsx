   ...
   return (
      <div className={` h-auto ${Active ? " overflow-y-hidden max-h-[100vh]" : ""}`} >
         ...
         <div className="min-h-[100vh] h-[100vh] bg-[#AA0000] flex flex-col justify-center">
            ...
            <br />
            <br />
            <button className="sora capitalize text-2xl sm:text-3xl border-[#cccccc] border-4 border-solid font-bold text-white mx-auto w-[12rem] sm:w-[20rem] py-4" onClick={()=>{navigate("/Contact")}}>
               Contact Me
            </button>
         </div>
